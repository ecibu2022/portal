      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-18 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-semibold text-cyan-800 hover:text-gray-500">
                     <Link to="/forgot" className="font-semibold text-cyan-800 hover:text-gray-500">Forgot password?</Link>
                  </a>
                </div>
              </div>
              <div className="mt-2">
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            Not a member?{" "}
            <Link to="/register" className="font-semibold text-cyan-800 hover:text-gray-500">
